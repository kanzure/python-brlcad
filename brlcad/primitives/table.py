...
MAGIC_TO_PRIMITIVE_TYPE = {
    ...
    librt.ID_ELL: ("ELL", Primitive, librt.RT_ELL_INTERNAL_MAGIC, librt.struct_rt_ell_internal),
    librt.ID_SPH: ("ELL", Primitive, librt.RT_ELL_INTERNAL_MAGIC, librt.struct_rt_ell_internal),
    ...
    librt.ID_TGC: ("TGC", Primitive, librt.RT_TGC_INTERNAL_MAGIC, librt.struct_rt_tgc_internal),
    librt.ID_REC: ("TGC", Primitive, librt.RT_TGC_INTERNAL_MAGIC, librt.struct_rt_tgc_internal),
